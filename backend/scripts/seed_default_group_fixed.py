...
# Get database connection parameters from environment variables with fallback to local development values
DB_USER = os.getenv("MYSQL_USER", "beer_user")
DB_PASSWORD = os.getenv("MYSQL_PASSWORD", "beergame123")
DB_NAME = os.getenv("MYSQL_DATABASE", "beer_game")
DB_PORT = os.getenv("MYSQL_PORT", "3307")
DB_HOST = os.getenv("MYSQL_HOST", "localhost")

print(f"Using MySQL database at: {DB_USER}@{DB_HOST}:{DB_PORT}/{DB_NAME}")
