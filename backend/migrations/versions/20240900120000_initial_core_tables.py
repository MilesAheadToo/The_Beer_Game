...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("order_placed", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("order_received", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("inventory_before", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("inventory_after", sa.Integer(), nullable=False, server_default="0"),
