...
@router.get("/games/{game_id}/agent-configs", response_model=List[AgentConfigInDB])
...
@router.get("/games/{game_id}/roles", response_model=Dict[str, RoleAssignment])
...
@router.put("/games/{game_id}/roles/{role}", response_model=RoleAssignment)
...
@router.get("/games/{game_id}/available-roles", response_model=List[str])
