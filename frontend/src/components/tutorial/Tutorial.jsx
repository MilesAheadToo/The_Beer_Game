  ...
  const steps = [
    {
      ...
      content: 'The Beer Game is a simulation that demonstrates the challenges of supply chain management. You\'ll take on the role of a supply chain manager and make decisions to optimize your inventory and meet customer demand.',
