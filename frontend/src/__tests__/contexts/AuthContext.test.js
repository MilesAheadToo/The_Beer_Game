...
describe('AuthContext', () => {
  ...
  describe('login', () => {
    it('should successfully log in a user', async () => {
      ...
      mixedGameApi.login.mockResolvedValueOnce(mockUser);
      ...
      expect(result.current.error).toBeNull();
      expect(mixedGameApi.login).toHaveBeenCalledWith({
        email: 'test@example.com',
        password: 'password123',
      });
    });
    ...
    it('should handle login failure', async () => {
      ...
      mixedGameApi.login.mockRejectedValueOnce({
  ...
  describe('logout', () => {
    it('should log out a user', async () => {
      ...
      mixedGameApi.getCurrentUser.mockResolvedValueOnce(mockUser);
      mixedGameApi.logout.mockResolvedValueOnce({});
      ...
      expect(mixedGameApi.logout).toHaveBeenCalled();
    });
  });
