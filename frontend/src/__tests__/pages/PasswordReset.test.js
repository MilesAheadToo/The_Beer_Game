...
describe('PasswordReset', () => {
  ...
  describe('Request Password Reset Form', () => {
    ...
    it('handles successful password reset request', async () => {
      const requestPasswordReset = require('../../services/api').mixedGameApi.requestPasswordReset;
  ...
  describe('Reset Password Form', () => {
    ...
    beforeEach(() => {
      ...
      require('../../services/api').mixedGameApi.resetPassword = jest.fn().mockResolvedValue({});
    });
    ...
    it('handles password reset failure', async () => {
      ...
      require('../../services/api').mixedGameApi.resetPassword.mockRejectedValue({
      ...
      await waitFor(() => {
        expect(require('../../services/api').mixedGameApi.resetPassword).toHaveBeenCalled();
      });
    });
